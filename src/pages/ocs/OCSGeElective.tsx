      ...
      <div className="space-y-4">
        ...
        {appDeadline && !approvalDeadline && (
          <div className="rounded-lg border-l-4 border-amber-400 bg-gradient-to-r from-amber-50 to-amber-100/60 px-5 py-4 flex items-start gap-4">
            ...
            <div>
              <p className="font-bold text-amber-900 text-sm">Student Application Deadline</p>
              <p className="text-xs text-amber-700 mt-0.5">Students may submit requests until <strong>{fmtDate(appDeadline)}</strong>.</p>
            </div>
          </div>
        )}
