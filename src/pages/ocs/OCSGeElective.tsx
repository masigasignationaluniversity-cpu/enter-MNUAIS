...
import {
  CheckCircle2, XCircle, Clock, BookMarked, Search, ChevronRight,
            ...
            {denyingId && (
              <div className="rounded-lg border border-destructive/30 bg-destructive/5 p-4 space-y-3">
                ...
                <div className="flex gap-2">
                  <Button size="sm" variant="destructive" onClick={handleDenySubmit}
                    disabled={!!processingId} className="h-8 text-xs gap-1.5">
