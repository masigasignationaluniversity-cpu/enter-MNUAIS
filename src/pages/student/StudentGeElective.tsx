                ...
                {approvedRequest && !pendingRequest && (
                  canChange ? (
                    ...
                    <div className="w-full space-y-1 pt-1">
                      <p className="text-xs font-medium text-destructive">Cannot change GE elective plan:</p>
                ...
                <div className="p-4 bg-background space-y-3">
                  {changeMode && (
                    <div className="flex items-start gap-2 rounded-md border border-blue-200 bg-blue-50 px-3 py-2 text-xs text-blue-800">
                      ...
                      <span>Requesting a change of GE elective plan. Your current approved plan will be replaced once OCS approves this request.</span>
                    </div>
                  )}
